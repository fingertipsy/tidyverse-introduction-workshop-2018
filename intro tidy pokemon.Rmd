...
Now have a look at the variables. There are a few variables that we might want to have as factor instead of character variables
...
- Look at the structure and the differences between integer variables and factor variables. (5min)
